    ...
    if update_channel:
        try:
            ...
            if user.status == "kicked":
               await bot.send_message(
                   chat_id=msg.chat.id,
                   text="Sorry Sir, You are Banned. Contact My [Support Group](https://t.me/Hollywood_0980).",
                   parse_mode="markdown",
...
"""
    reply_markup = InlineKeyboardMarkup(
        [
            ...
            [
                InlineKeyboardButton('⭕️ Source code ⭕️', url='https://github.com/Subhan-1/TG-StringSession'),
            ],
            [
                InlineKeyboardButton('DEVELOPER', url='https://t.me/Subhan011'),
            ]
        ]
    )
